    ...
    pub fn parse(tag: &str) -> Option<Self> {
                ...
                0 => {
                    match len {
                        2 => {
                            ...
                            match (a, b) {
                                (b'z', b'h') => zh = true,
                                (b'j', b'a') => lang.cjk = Han::Japanese,
                                (b'k', b'o') => lang.cjk = Han::Korean,
                                _ => {}
                            };
                            lang.language[0] = a;
                            lang.language[1] = b;
        ...
        if lang_index != 0xFFFF {
            ...
            let (tag, cjk) = match lang.script().unwrap_or("") {
                "Hant" => (tag_from_bytes(b"ZHT "), Han::Traditional),
                "Hans" => (tag_from_bytes(b"ZHS "), Han::Simplified),
                _ => (tag_from_bytes(b"ZHT "), Han::Traditional),
            };
            lang.tag = Some(tag);
            lang.cjk = cjk;
